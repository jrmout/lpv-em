function [lambda, loglik]=em_mix_inv_lds(data, n_comp, varargin)
% EM_MIX_INV_LDS fits a Gaussian mixture of stable inverse linear 
% dynamical systems to data with the EM algorithm (Maximum likelihood).
% 
%   USAGE:
%   [lambda, loglik] = EM_MIX_INV_LDS(data, n_comp) fits a mixture of inverse
%   linear dynamical systems to data and returns the inverse of the system
%   matrices and the estimated attractor.
%
%
%   INPUT PARAMETERS:
