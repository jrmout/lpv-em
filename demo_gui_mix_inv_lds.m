...
% the mixture of inverse linear systems model. After drawing a trajectory, 
% the model will be trained automatically. If you want to discard all 
% the previous data, press the 'clear' button. 
% This model provides convex updates but can be inaccurate due to the
% inverse formulation. 
