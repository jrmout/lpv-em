...
options.c_reg_inv = 1e-2;               % Pos def eps margin (YALMIP only)
...
lambda = estimate_stable_inv_lds(data, 0, options); % second argument will be ignored

% Plot result
plot_streamlines_inv_lds(lambda, limits);