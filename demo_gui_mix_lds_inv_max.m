...
% the LPV-EM algorithm. After drawing a trajectory, the model will be trained
...
options.c_reg_inv = 5e-1;              % Pos def eps margin (inverse problem)
...
options.max_iter = 30;                 % Max number of iter for nonlinear solver
options.min_eig_loc = 1e-0;             % Minimum eigenvalue state covariance
